...
const struct atts_desc proxr_ias_att_db[IAS_IDX_NB] =
{
...
const atts_svc_desc_t proxr_ias_svc         = ATT_SVC_IMMEDIATE_ALERT;

/// Alert Level Service - Heart Rate Measurement Characteristic
const struct atts_char_desc proxr_ias_alert_lvl_char = ATTS_CHAR(ATT_CHAR_PROP_WR_NO_RESP,
                                                                    0,
                                                                    ATT_CHAR_ALERT_LEVEL);

/// TX Power Service
const atts_svc_desc_t proxr_txps_svc     = ATT_SVC_TX_POWER;

/// TX Power Service -TX Power Level Characteristic
const struct atts_char_desc proxr_txps_tx_power_lvl_char = ATTS_CHAR(ATT_CHAR_PROP_RD,
                                                                         0,
