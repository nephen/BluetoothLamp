...
extern const struct atts_desc scpps_att_db[SCPS_IDX_NB];

///Scan Parameters Service
extern const atts_svc_desc_t scps_svc;

///Scan Parameters Service Scan Interval Window Characteristic
extern const struct atts_char_desc scps_scan_intv_wd_char;
///Scan Parameters Service Scan Refresh Characteristic
extern const struct atts_char_desc scps_scan_refresh_char;
