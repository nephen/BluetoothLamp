...
extern const struct atts_desc diss_att_db[DIS_IDX_NB];

extern const atts_svc_desc_t diss_dis_svc;

extern const struct atts_char_desc diss_manufacturer_name_char;
extern const struct atts_char_desc diss_model_nb_str_char;
extern const struct atts_char_desc diss_serial_nb_str_char;
extern const struct atts_char_desc diss_hard_rev_str_char;
extern const struct atts_char_desc diss_firm_rev_str_char;
extern const struct atts_char_desc diss_sw_rev_str_char;
extern const struct atts_char_desc diss_system_id_char;
extern const struct atts_char_desc diss_ieee_char;
extern const struct atts_char_desc diss_pnp_id_char;
