...
extern const struct atts_desc findt_att_db[FINDT_IAS_IDX_NB];

extern const atts_svc_desc_t findt_ias_svc;

extern const struct atts_char_desc findt_alert_lvl_char;
