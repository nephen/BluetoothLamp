...
///Parameters of the @ref HOGPD_BOOT_REPORT_UPD_REQ and @ref HOGPD_BOOT_REPORT_IND - Need to be dynamically allocated
...
extern void task_hogpd_desc_register(void);
