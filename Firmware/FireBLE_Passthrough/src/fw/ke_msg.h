 ...
 * @file ke_msg.h
 *
 * @brief This file contains the definition related to msg scheduling.
 *
...
#define KE_MSG_ALLOC_DYN(id, dest, src, param_str,length)  (struct param_str*)ke_msg_alloc(id, dest, src, \
	(sizeof(struct param_str)-sizeof(uint8_t) + length));
 ...
 ****************************************************************************************
 */
typedef void* (*p_ke_msg_alloc)(ke_msg_id_t const id, ke_task_id_t const dest_id,
                   ke_task_id_t const src_id, uint16_t const param_len);
#define  ke_msg_alloc ((p_ke_msg_alloc)(_ke_msg_alloc))
...
/**
 ****************************************************************************************
 * @brief Message sending firstly.
 *
 * Send a message previously allocated with any ke_msg_alloc()-like functions 
 * and the kernel will insert the message to the front of the sent queue.
 *
 * The kernel will take care of freeing the message memory.
 *
 * Once the function have been called, it is not possible to access its data
 ...
 ****************************************************************************************
 */
typedef void (*p_ke_msg_send_front)(void const *param_ptr);
#define ke_msg_send_front ((p_ke_msg_send_front)(_ke_msg_send_front))
 ...
 ****************************************************************************************
 */
typedef void (*p_ke_msg_send_basic)(ke_msg_id_t const id, ke_task_id_t const dest_id, ke_task_id_t const src_id);
#define ke_msg_send_basic ((p_ke_msg_send_basic)(_ke_msg_send_basic))
 ...
 ****************************************************************************************
 */
typedef void (*p_ke_msg_forward)(void const *param_ptr, ke_task_id_t const dest_id, ke_task_id_t const src_id);
#define ke_msg_forward ((p_ke_msg_forward)(_ke_msg_forward))
 ...
 ****************************************************************************************
 */
typedef void (*p_ke_msg_free)(struct ke_msg const *param);
#define ke_msg_free ((p_ke_msg_free)(_ke_msg_free))
