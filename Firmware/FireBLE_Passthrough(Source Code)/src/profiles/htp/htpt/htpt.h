...
extern const struct atts_desc htpt_att_db[HTS_IDX_NB];

/// Health Thermometer Service
extern const atts_svc_desc_t htpt_hlth_therm_svc;

/// Temperature Measurement Char.
extern const struct atts_char_desc htpt_temp_meas_char;
/// Temperature Type Char.
extern const struct atts_char_desc htpt_temp_type_char;
/// Intermediate Temperature Char.
extern const struct atts_char_desc htpt_interm_temp_char;
/// Measurement Interval Char.
extern const struct atts_char_desc htpt_meas_intv_char;
