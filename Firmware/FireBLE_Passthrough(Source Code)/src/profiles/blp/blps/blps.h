...
extern const struct atts_desc blps_att_db[BPS_IDX_NB];

/// Blood Pressure Sensor Service - only one instance for now
extern const atts_svc_desc_t blps_bps_svc;

extern const struct atts_char_desc blps_bp_meas_char;
extern const struct atts_char_desc blps_interm_cuff_press_char;
extern const struct atts_char_desc blps_bp_feature_char;
