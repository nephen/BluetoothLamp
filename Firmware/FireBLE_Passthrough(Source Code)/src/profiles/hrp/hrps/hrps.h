...
extern const struct atts_desc hrps_att_db[HRS_IDX_NB];

/// Heart Rate Sensor Service - only one instance for now
extern const atts_svc_desc_t hrps_hrs_svc;

extern const struct atts_char_desc hrps_hr_meas_char;
extern const struct atts_char_desc hrps_body_sensor_loc_char;
extern const struct atts_char_desc hrps_hr_cntl_point_char;
