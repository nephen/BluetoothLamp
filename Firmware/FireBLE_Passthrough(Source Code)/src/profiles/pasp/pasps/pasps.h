...
extern const struct atts_desc pasps_att_db[PASS_IDX_NB];

/// Phone Alert Status Service
extern const atts_svc_desc_t pasps_pass_svc;

/// Alert Status Char.
extern const struct atts_char_desc pasps_alert_status_char;
/// Ringer Status Char.
extern const struct atts_char_desc pasps_ringer_setting_char;
/// Ringer Control Point Char.
extern const struct atts_char_desc pasps_ringer_ctnl_pt_char;
