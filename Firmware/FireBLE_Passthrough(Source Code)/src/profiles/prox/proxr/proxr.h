...
extern const struct atts_desc proxr_lls_att_db[LLS_IDX_NB];
/// IAS Database Description
extern const struct atts_desc proxr_ias_att_db[IAS_IDX_NB];
/// TXPS Database Description
extern const struct atts_desc proxr_txps_att_db[TXPS_IDX_NB];
...
/// Link Loss Service
extern const atts_svc_desc_t proxr_lls_svc;
/// Link Loss Service - Alert Level Characteristic
extern const struct atts_char_desc proxr_lls_alert_lvl_char;

/// Immediate Alert Service
extern const atts_svc_desc_t proxr_ias_svc;
/// Immediate Alert Service - Alert Level Characteristic
extern const struct atts_char_desc proxr_ias_alert_lvl_char;

/// TX Power Service
extern const atts_svc_desc_t proxr_txps_svc;
/// TX Power Service -TX Power Level Characteristic
extern const struct atts_char_desc proxr_txps_tx_power_lvl_char;
