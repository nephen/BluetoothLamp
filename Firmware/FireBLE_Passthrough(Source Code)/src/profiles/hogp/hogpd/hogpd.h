...
struct hogpd_hids_cfg
{
    ...
    struct atts_incl_desc ext_rep_ref;
...
extern const struct atts_desc hids_att_db[HOGPD_IDX_NB];

/// HID Service
extern const atts_svc_desc_t hid_svc;

/// HID Service Characteristics
extern const struct atts_char_desc hids_proto_mode_char;
extern const struct atts_char_desc hids_report_char;
extern const struct atts_char_desc hids_report_map_char;
extern const struct atts_char_desc hids_boot_kb_in_report_char;
extern const struct atts_char_desc hids_boot_kb_out_report_char;
extern const struct atts_char_desc hids_boot_mouse_in_report_char;
extern const struct atts_char_desc hids_hid_info_char;
extern const struct atts_char_desc hids_hid_ctnl_pt_char;
