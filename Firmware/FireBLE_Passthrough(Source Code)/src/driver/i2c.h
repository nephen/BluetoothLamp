...
typedef int    (*p_I2C_BYTE_WRITE)(uint8_t saddr, uint8_t reg_addr, uint8_t reg_data);
typedef uint8_t (*p_I2C_BYTE_READ)(uint8_t saddr, uint8_t reg_addr);
typedef int    (*p_I2C_BYTE_WRITE2)(uint8_t saddr, uint16_t reg_addr, uint8_t reg_data);
typedef uint8_t (*p_I2C_BYTE_READ2)(uint8_t saddr, uint16_t reg_addr);
typedef int    (*p_I2C_nBYTE_WRITE2)(uint8_t saddr, uint16_t reg_addr, uint8_t *buffer, uint16_t len);
typedef int    (*p_I2C_nBYTE_READ2)(uint8_t saddr, uint16_t reg_addr, uint8_t *buffer, uint16_t len);
typedef int    (*p_I2C_CMD_WRITE)(uint8_t saddr, uint8_t *buffer, uint16_t len);
typedef int    (*p_I2C_DATA_READ)(uint8_t saddr, uint8_t *buffer, uint16_t len);
...
#define I2C_CMD_WRITE   ((p_I2C_CMD_WRITE) _I2C_CMD_WRITE)
#define I2C_DATA_READ    ((p_I2C_DATA_READ)  _I2C_DATA_READ)
...
extern int I2C_BYTE_WRITE(uint8_t saddr, uint8_t reg_addr, uint8_t reg_data);
extern uint8_t I2C_BYTE_READ(uint8_t saddr, uint8_t reg_addr);
extern int I2C_BYTE_WRITE2(uint8_t saddr, uint16_t reg_addr, uint8_t reg_data);
extern uint8_t I2C_BYTE_READ2(uint8_t saddr, uint16_t reg_addr);
extern int I2C_nBYTE_WRITE(uint8_t saddr, uint8_t reg_addr, uint8_t *buffer, uint16_t len);
extern int I2C_nBYTE_READ(uint8_t saddr, uint8_t reg_addr, uint8_t *buffer, uint16_t len);
extern int I2C_nBYTE_WRITE2(uint8_t saddr, uint16_t reg_addr, uint8_t *buffer, uint16_t len);
extern int I2C_nBYTE_READ2(uint8_t saddr, uint16_t reg_addr, uint8_t *buffer, uint16_t len);
extern int I2C_CMD_WRITE(uint8_t saddr,uint8_t *buffer, uint16_t len);
extern int I2C_DATA_READ(uint8_t saddr,uint8_t *buffer, uint16_t len);
#endif
