 ...
 *****************************************************************************************
 */
int I2C_nBYTE_READ(uint8_t saddr, uint8_t reg_addr, uint8_t *buffer, uint16_t len)
{
    int ret = 0;
		uint32_t i;
 ...
 *****************************************************************************************
 */
int I2C_nBYTE_READ2(uint8_t saddr, uint16_t reg_addr, uint8_t *buffer, uint16_t len)
{
    uint32_t i;
		int ret = 0;
 ...
 *****************************************************************************************
 */
int I2C_BYTE_WRITE(uint8_t saddr, uint8_t reg_addr, uint8_t reg_data)
{
    //Store environment parameters
    i2c_env.i2cOpFsm = I2C_OP_IDLE;
    i2c_env.i2cIndex = 0;
 ...
 *****************************************************************************************
 */
int I2C_BYTE_WRITE2(uint8_t saddr, uint16_t reg_addr, uint8_t reg_data)
{
    //Store environment parameters
    i2c_env.i2cOpFsm = I2C_OP_IDLE;
    i2c_env.i2cIndex = 0;
 ...
 *****************************************************************************************
 */
int I2C_nBYTE_WRITE(uint8_t saddr, uint8_t reg_addr, uint8_t *buffer, uint16_t len)
{
    uint32_t i;
 ...
 *****************************************************************************************
 */
int I2C_nBYTE_WRITE2(uint8_t saddr, uint16_t reg_addr, uint8_t *buffer, uint16_t len)
{
    uint32_t i;
...
int I2C_CMD_WRITE(uint8_t saddr,uint8_t *buffer, uint16_t len)
{
    uint32_t i;
    ...
    i2c_env.i2cOpFsm = I2C_OP_IDLE;
    i2c_env.i2cIndex = 0;
    i2c_env.i2cTxCount = len;
    i2c_env.i2cRxCount = 0;
    //i2c_env.i2cBuffer[0] = reg_addr;
    for (i = 0; i < len; i++) {
        i2c_env.i2cBuffer[i] = buffer[i];
    }
